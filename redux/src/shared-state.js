...
export function addFavorite(item) { // Action creators
    return {
        type: ADD_FAV_ACTION,
        item: item
    }
...
store.subscribe(() => localStorage.setItem(LS_KEY, JSON.stringify(store.getState()))); // CALLED WHENEVER DATA CHANGES