...
if(navigator.mediaDevices && navigator.mediaDevices.getUserMedia) {
    navigator.mediaDevices.getUserMedia({video: true}) // If video is available
        .then(function(stream) {
            ...
            canvas.addEventListener("mousedown", function(evt) { // Drawing
                mouseIsDown = true;
                ctx.beginPath();
                ctx.strokeStyle = "#FF0";
    ...
    alert("Stop using a garbage browser, go download Firefox or Chrome");
}